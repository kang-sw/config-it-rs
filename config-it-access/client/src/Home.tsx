  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center h-screen">
        <Button onClick={onClick} theme="info">
          Click-Me!
        </Button>
      </div>
    </>
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center h-full bg-slate-800">
        ...
        <h2 className="text-2xl mt-3 font-bold font-mono text-gray-400">
          configure everything, control anywhere
        </h2>
...
export function RepoIcon(props: { className?: string }) {
  return (
    <a href="https://github.com/kang-sw/config-it-rs">
      <svg
        height="32"
        aria-hidden="true"
        viewBox="0 0 16 16"
