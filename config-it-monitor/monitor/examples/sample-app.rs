        ...
        config_it_monitor::server::Service::builder()
            ...
            .table(
                StorageTable::default()
                    ...
                    .submit()
                    .entry("default-unauth", storage.clone())
                    .submit()
                    .entry("default-readonly", storage.clone())
                    .add_access_key("admin:admin", false)
                    .submit()
                    .entry("other-name-multi-auth", storage.clone())
                    .add_access_key("admin:admin", true)
                    .add_access_key("admin:admin2", false)
                    .submit()
                    .entry("de?fault", storage.clone())
                    .submit(),
            )
            .system_name("example")
